  ...
  return (
    <div className="w-full max-w-7xl flex justify-between items-center max-md:max-w-full max-md:flex-col max-md:justify-center">
      <div className="mt-8 md:mt-16 md:ml-16">
        <div
          className="w-24 h-9 bg-[#D9D9D9] border border-solid border-[#000000] rounded-3xl flex items-center cursor-pointer relative"
          onClick={() => setIsDarkMode((prev) => !prev)}
        >
          <div className="w-7 h-7 bg-black rounded-full absolute left-1 dark:left-[calc(100%-32px)]" />
        </div>
      ...
      <div className="w-[450px] bg-[#D9D9D9] dark:bg-[#444444] mt-8 md:mt-16 md:mr-16 gap-4 pl-6 pr-9 py-2 border border-solid border-[#000000] dark:border-none rounded-[40px] shadow-2xl flex items-center">
